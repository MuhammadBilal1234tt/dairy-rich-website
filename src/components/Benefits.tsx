        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <ScrollReveal key={benefit.title} delay={index * 150}>
              <div
                className={`relative card-hover rounded-3xl p-8 text-white ${benefit.color} overflow-hidden ${
          ...
          <div className="bg-white border border-[#E0EDFF] rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-xl shadow-blue-500/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="bg-[#25D366] hover:bg-[#1ebe5d] text-white px-8 py-4 rounded-full font-semibold text-base flex items-center gap-3 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg shadow-green-500/30"
              >
              ...
              <a
                ...
                className="border border-[#0046A4] text-[#0046A4] hover:bg-[#0046A4] hover:text-white px-8 py-4 rounded-full font-semibold text-base transition-all duration-300 text-center"
              >
                Learn More
              </a>
            </div>
