        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <ScrollReveal direction="left">
            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-blue-500/10 border-4 border-white">
              <iframe
                src="https://maps.app.goo.gl/ZkkEyumJNpXzJs919"
                width="100%"
                height="450"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Dairy Rich delivery coverage area – Lahore"
                className="w-full"
              />
            </div>
          ...
          <ScrollReveal direction="right">
            <div className="bg-white rounded-3xl p-8 shadow-xl shadow-blue-500/5 border border-[#E0EDFF]">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-[#003DA5] to-[#1BA0A8] rounded-xl flex items-center justify-center text-xl">
                  🗺️
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#003DA5]">Delivery Areas</h3>
              ...
              <div className="grid grid-cols-2 gap-2 mb-6">
                {deliveryAreas.map((area, index) => (
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#1BA0A8] flex-shrink-0" />
                    {area}
                  </div>
                ))}
              </div>
              ...
              <div className="bg-[#F5F9FF] rounded-2xl p-4 text-center">
                ...
                <p className="text-[#003DA5] font-semibold text-sm">
